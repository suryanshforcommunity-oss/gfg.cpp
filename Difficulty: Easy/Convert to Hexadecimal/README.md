<h2><a href="https://www.geeksforgeeks.org/problems/convert-to-hexadecimal--122416/1?page=6&category=CPP&sortBy=submissions">Convert to Hexadecimal</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given an integer <strong>a,&nbsp;</strong><span style="font-size: 18.6667px;">convert the decimal number <strong>a</strong> into its hexadecimal representation and print the answer.</span><br></span></p>
